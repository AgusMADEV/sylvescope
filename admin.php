...
if (!isset($_SESSION['admin_loggedin'])) {
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['admin_login'])) {
        ...
        // For simplicity, only user 'agusmadev' is considered admin.
        if ($admin && $username === 'agusmadev' && $admin['password'] === $password) {
...
if ($action == 'delete_user' && isset($_GET['id'])) {
    ...
    if ($user && $user['username'] === 'agusmadev') {
