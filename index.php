...
if (!isset($_SESSION['loggedin'])) {
    if (isset($_POST['login'])) {
        ...
        // Default credentials: username "agusmadev" and password "agusmadev"
        if ($username === 'agusmadev' && $password === 'agusmadev') {
    ...
    <head>
      <meta charset="utf-8">
      <title>Login - SylveScope Dashboard</title>
...
if (isset($_POST['dp_action']) && $_POST['dp_action'] === 'generate_report') {
    require_once 'SylveScope.php';
    $url = trim($_POST['url']);
    $web = new SylveScope($url);
    ob_start();
...
<head>
  <meta charset="utf-8">
  <title>SylveScope Dashboard</title>
  <link rel="stylesheet" href="css/style.css">
  <style>
...
<body>
  ...
  <div id="dashboard-header">
    <div>
      ...
      <p>SylveScope Dashboard – Manage Your Reports</p>
    </div>
    <div>
